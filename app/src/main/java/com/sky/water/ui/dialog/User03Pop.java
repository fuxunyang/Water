...
import com.sky.water.ui.activity.BalanceActivity;
import com.sky.water.ui.activity.BindCardActivity;
 ...
 * 分享弹出框
 */
public class User03Pop extends PopupWindow {
    private OnRequestCallback<Boolean> callback;

    public User03Pop(View contentView) {
        this(contentView, ViewGroup.LayoutParams.WRAP_CONTENT, ViewGroup.LayoutParams.WRAP_CONTENT);
    }

    public User03Pop(View contentView, int width, int height) {
        this(contentView, width, height, true);
    }

    public User03Pop(View contentView, int width, int height, boolean focusable) {
...
//        setAnimationStyle(R.style.AnimationFade);
        ...
        contentView.findViewById(R.id.layout_01).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                jumpActivity(context, BindCardActivity.class);
                dismiss();
            }
        });
        contentView.findViewById(R.id.layout_02).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                jumpActivity(context, BalanceActivity.class);
                dismiss();
            }
        });
    }
